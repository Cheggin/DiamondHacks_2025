...
//       // Step 1: Get the first word of the "1st choice"
//       const firstChoice = data["1st choice"];
//       const firstWord = firstChoice?.split(' ')[0]?.trim();

//       // Step 2: Query side effects from FDA API
...
//           sideEffects = Array.from(allReactions);
//           data["1st choice side effects"] = sideEffects;
//         } else {
//           console.warn(`FDA API error: ${fdaResponse.status}`);
//         }
//       }
